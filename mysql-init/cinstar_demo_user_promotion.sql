...
CREATE TABLE `user_promotion` (
  ...
  KEY `FKh0d59wnsplwd93et25mi9r2gs` (`user_id`),
  ...
  CONSTRAINT `FKh0d59wnsplwd93et25mi9r2gs` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
INSERT INTO `user_promotion` VALUES (5,1),(5,3);
